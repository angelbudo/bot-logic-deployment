        ...
        {loading ? (
          ...
          <div className="flex flex-col gap-3">
            ...
            <div className="grid grid-cols-2 sm:grid-cols-3 gap-2">
              ...
              <StatBox icon={<Trophy className="w-3 h-3 text-[#e6b033]" />} label="Victòries" value={profile.wins} accent="text-primary font-bold text-[#e6b033]" valueClassName="text-slate-100" labelClassName="text-[#e6b033]" />
              ...
              <StatBox icon={<Star className="w-3 h-3 text-[#e6b033]" />} label="% Victòries" value={`${winRate}%`} accent="text-foreground/30 font-bold text-slate-100" labelClassName="text-[#e6b033]" />
